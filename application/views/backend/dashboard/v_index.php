...
<hr>
<p><span class="label label-info">[2021.06.22]</span> Если залогинены, на сайте в меню будет кнопка '+ Добавить статью' для удобного пользования и меньших телодвижений.<br>Так же кнопка 'В админку'</p>
