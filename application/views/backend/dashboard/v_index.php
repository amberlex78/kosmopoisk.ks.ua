...
<hr>
<p><span class="label label-info">[2021.06.22]</span> Если залогинены, в меню будет кнопка '+ Добавить статью' для удобного пользования и меньших телодвижений.<br>Так же кнопка 'В админку'</p>
<p><?php echo HTML::image('uploads/images/add_article.png', array('class' => 'img-rounded', 'style' => 'width: 870px')) ?></p>
<hr>
<p><span class="label label-info">[2021.06.02]</span> Перенес панель с меню вправо. Теперь при добавлении или редактировании статьи редактор текста получается почти посредине экрана, что удобнее.</p>
